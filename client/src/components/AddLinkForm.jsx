...
import { Plus, Link2, FolderPlus, Tag, Clock, Bell, X, Calendar } from "lucide-react";
import { axiosInstance } from "../lib/axios.js";
import { useToast } from "@/hooks/use-toast";
import GoogleCalendarSync from "./GoogleCalendarSync";
// import { useSelector } from "react-redux";

const AddLinkForm = ({ onAddLink, onCreateGroup, groups = [], onGoogleSyncNeeded }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isCreatingGroup && formData.newGroup) {
        await onCreateGroup(selectedGrp);
      }
      ...
      console.error("Error in AddLinkForm handleSubmit:", error);
      toast({
        title: "Error",
        description: "Failed to add link or create group",
        variant: "destructive",
      });
    }
  };
  ...
  return (
    <>
      <GoogleCalendarSync onTokenRefreshed={handleTokenRefreshed} />
